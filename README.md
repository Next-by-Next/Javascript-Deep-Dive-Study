...
||19명|17명|15명|8명|13명|8명|9명|7명|6명|7명|
...
> 함수와 일급 객체 / 프로토타입 / strict mode / 빌트인 객체 / this / 실행 컨텍스트 / 클로저 / 클래스 / ES6 함수의 추가 기능 | 배열 | Number | 
...
| DAY 3 (월,화)      | DAY 4 ( 수, 목 )   | ❗️ DAY 5 (금)      |  DAY 6 (토, 일)
| --------------- | ---------------- | ---------------- |  - |
...
| DAY 7 (월,화)      | ❗️ DAY 8 (수)   |   DAY 9 (목, 금)   |      DAY 10 (토, 일)   |  
| --------------- | ----------------- | -| - |
| 22.1 ~ 22.2 (TIL) | 23.1 ~ 23.5 (TIL) | 23.6 ~ 23.7 (TIL) |  24.1 ~ 24.3  (TIL)|
...
| DAY 11 ( 화, 수) | DAY 12 (목, 금, 토, 일)   
| ----------------- | ----------------- | 
| 24.4 ~ 24.6 (TIL) | 25.1 ~ 25.8 (TIL) | 
...
| DAY 13 (월, 화)   | DAY 14 (수, 목)| DAY 15 (금, 토) | ❗️ DAY 16 (일)|
| ----------------- | ----------------- | -| -| 
| 26.1 ~ 26.5 (TIL)  | 27.1 ~ 27.7 (TIL) | 27.8 ~ 27.9 (TIL) | 28.1 ~ 28.3 (TIL)| 
