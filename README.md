...
| :--------------: | :-------------: | :----------------:| :----------------: | :------------:|
| 변수             | 표현식과 문      | 표현식과 문        | 데이터 타입          |    데이터 타입     | 
| 5.1 ~ 5.6 (TIL) | 6.1 ~ 6.5 (TIL)|6.6 ~ 6.10 (TIL) |  7.1 ~ 7.5 (TIL) | 7.6 ~ 7.13 (TIL) |
...
| :--------------: | :-------------: | :----------------:| :----------------: | :------------:| :------------:|
| 제어문            | 타입 변환과 단축 평가 | 타입 변환과 단축 평가  | 객체 리터럴         |  객체 리터럴     | 원시 값과 객체의 비교 |
| 8.1 ~ 8.5 (TIL) | 9.1 ~ 9.2 (TIL) | 9.3 ~ 9.4 (TIL)| 10.1 ~ 10.5 (TIL)| 10.6 ~ 10.9 (TIL)| 11.1 (TIL)  |
...
| :--------------: | :-------------: | :----------------:| :----------------: | :------------:| :------------:|
| 함수              |  함수            | 함수               | 스코프               |  스코프     | 전역 변수의 문제점 |
| 12.1 ~ 12.4.3 (TIL)| 12.4.4 ~ 12.6 (TIL)| 12.7 (TIL)   | 13.1 ~ 13.2 (TIL)| 13.3 ~ 13.5 (TIL) |14.1 ~ 14.3 (TIL)|  
...
| :--------------: | :-------------: | :----------------:| :----------------: | :------------:| :------------:|
|     키워드 & 스코프  |  프로퍼티 어트리뷰트 | 프로퍼티 어트리뷰트    | 생성자 함수에 의한 객체생성 |생성자 함수에 의한 객체생성 | 함수와 일급 객체|
| 15.1 ~ 15.4 (TIL)  | 16.1 ~ 16.3 (TIL) | 16.4 ~ 16.5 (TIL) | 17.1 ~ 17.2.3 (TIL)|17.2.4 ~ 17.2.7 (TIL)|  18 (TIL) |

---

> **5주차**  (11 / 27 ~ 12 / 2)

| DAY 25 (월)       | DAY 26 (화) | DAY 27 (수)        | DAY 28 (목)       | DAY 29 (금)          |DAY 30 (토)         |
| :--------------: | :-------------: | :----------------:| :----------------: | :------------:| :------------:|
|    프로토 타입  |프로토 타입  |프로토 타입  |프로토 타입  |프로토 타입  |프로토 타입  |프로토 타입  |
 19.1 ~ 19.2 (TIL)  | 19.3 (TIL) | 19.4 ~ 19.6 (TIL) | 19.7 ~ 19.9 (TIL) | 19.10 ~ 19.11 (TIL)|  19.12 ~ 19.14 (TIL)|
